...
from mathledict import mathleDict
...
def best(wordlist, green, grey, yellow):
  ...
  for word in mathleDict:

    # in mathle, we can't use any grey letters
    if mathleDict[word] & grey:
      continue
...
if __name__ == '__main__':
  ...
  # green is a single 9 character string that indicate the
  # positions of green squares
  green = '...32=0.6'
 
  # yellow is a list of 9 character strings that indicate the
  ...
  wordlist = possibles(mathleDict, green, grey, yellow)
